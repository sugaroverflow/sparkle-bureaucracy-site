...
const events: Event[] = [
  {
    ...
    title: "DMV Redesign",
    description:
      "Can you redesign the felt experience of a terrible government service encounter?",
    date: "March 15, 2025",
  ...
  },
  {
    ...
    description:
      "What does a trust-building verification process look like when designed with the people it currently excludes?",
    date: "April 22, 2025",
  ...
  },
  {
    ...
    description:
      "How do you achieve institutional re-legitimation of participatory feedback for a world where synthetic voice is cheap?",
    date: "May 10, 2025",
    location: "Newspeak House",
  ...
  {
    id: "04",
    title: "Liquid Democracy Election",
    description:
      "Where does trust live, in the paper or the screen? What does delegation feel like when it's tangible?",
    date: "June 5, 2025",
    location: "TBA",
...
export function EventsSection() {
  return (
    <SectionWrapper id="experiments" number="03" label="Experiments" accent="pink">
      <div className="py-16">
        {/* Section Header */}
        <div className="mb-12">
