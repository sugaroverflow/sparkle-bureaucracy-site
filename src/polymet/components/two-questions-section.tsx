  ...
  return (
    <SectionWrapper id="subscribe">
      <div className="py-16 md:py-20">
        <div className="relative overflow-hidden border border-white/20 bg-white/[0.045] shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
          ...
          <div className="p-7 sm:p-10 lg:p-12">
            ...
            <div className="grid items-end gap-8 lg:grid-cols-[minmax(0,0.7fr)_minmax(28rem,1.3fr)] lg:gap-12">
              <div>
